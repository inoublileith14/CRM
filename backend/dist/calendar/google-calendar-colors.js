...
exports.GOOGLE_CALENDAR_LIST_COLORS = exports.GOOGLE_CALENDAR_EVENT_COLORS = void 0;
exports.resolveGoogleEventColors = resolveGoogleEventColors;
exports.GOOGLE_CALENDAR_EVENT_COLORS = {
...
exports.GOOGLE_CALENDAR_LIST_COLORS = {
...
function resolveGoogleEventColors(eventColorId, calendarColorId) {
    if (eventColorId && exports.GOOGLE_CALENDAR_EVENT_COLORS[eventColorId]) {
        const entry = exports.GOOGLE_CALENDAR_EVENT_COLORS[eventColorId];
        return {
            backgroundColor: entry.background,
            foregroundColor: entry.foreground,
        };
    }
    if (calendarColorId && exports.GOOGLE_CALENDAR_LIST_COLORS[calendarColorId]) {
        const entry = exports.GOOGLE_CALENDAR_LIST_COLORS[calendarColorId];
        return {
            backgroundColor: entry.background,
            foregroundColor: entry.foreground,
        };
    ...
    return {
        backgroundColor: exports.GOOGLE_CALENDAR_EVENT_COLORS['9'].background,
        foregroundColor: exports.GOOGLE_CALENDAR_EVENT_COLORS['9'].foreground,
    };
}
//# sourceMappingURL=google-calendar-colors.js.map