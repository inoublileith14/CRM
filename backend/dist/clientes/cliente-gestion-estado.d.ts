export declare const CLIENTE_GESTION_ESTADOS_ALQUILER: readonly ["no_gestionando", "gestionando", "visita_concertada", "nc", "pendiente_cuadrar_docs", "perfil_no_encaja", "videollamada", "ya_encontro_piso"];
...
export declare const CLIENTE_GESTION_ESTADOS: readonly ["no_gestionando", "gestionando", "visita_concertada", "nc", "pendiente_cuadrar_docs", "perfil_no_encaja", "videollamada", "ya_encontro_piso", "no_gestionado", "gestionando_w", "visita_concertada", "nc", "pendiente_cuadrar_visita", "ya_compro", "perfil_no_encaja", "videollamada"];
