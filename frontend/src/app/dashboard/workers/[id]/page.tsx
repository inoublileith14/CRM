  ...
  if (showError || !worker) {
    return (
      <div className="rounded-xl border border-red-200 bg-red-50 p-6 text-center">
        <p className="font-medium text-red-800">No se pudo cargar el trabajador</p>
        <button
          type="button"
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-start sm:justify-between">
          <div className="min-w-0">
            <div className="flex flex-wrap items-center gap-3">
              <h1 className="text-xl font-bold text-slate-900 sm:text-2xl">{worker.nombre}</h1>
            ...
            {worker.notas && (
              <p className="mt-2 text-sm text-slate-600">{worker.notas}</p>
            )}
          </div>
      ...
      <section className="w-full rounded-xl border border-slate-200 bg-white shadow-sm">
          ...
          {clientes.length > 0 && (
            <div className="relative w-full sm:max-w-md">
              ...
              <input
                ...
                className="w-full rounded-lg border border-slate-300 py-2 pl-10 pr-3 text-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20"
              />
            </div>
          )}
        </div>
        ...
        {clientes.length === 0 ? (
          <p className="py-10 text-center text-slate-500">
            Este trabajador no tiene clientes asignados. Asigna trabajadores desde la ficha de cada cliente.
          </p>
