  ...
  return (
    <div>
      <div className="mb-6 sm:mb-8">
        ...
        <h1 className="text-xl font-bold text-slate-900 sm:text-2xl">Editar inmueble</h1>
        <p className="mt-1 text-slate-500">
          {inmueble.nombre_propi || inmueble.direccion_piso_real || 'Sin nombre'}
        </p>
      </div>
      ...
      <div className="mx-auto max-w-5xl rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
        <InmuebleForm
          ...
          loading={saving}
          fixedTipoOperacion={expectedTipo ?? inmueble.tipo_operacion ?? undefined}
        />
      </div>
    </div>
  );
